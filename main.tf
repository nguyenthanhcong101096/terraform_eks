...
module "eks" {
  ...
  public_subnets      = [module.vpc.public_subnets["public-eks-2"].id, module.vpc.public_subnets["public-eks-2"].id]
  private_subnets     = [module.vpc.private_subnets["private-eks-2"].id, module.vpc.private_subnets["private-eks-2"].id]
